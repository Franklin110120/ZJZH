...
namespace Mario
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            creditFont = Content.Load<SpriteFont>("credits");
            
           
            
            running = Content.Load<Texture2D>("running");
            dead = Content.Load<Texture2D>("dead");
            standing = Content.Load<Texture2D>("standing");
            this.sprite = new StandingSprite(standing, 1, 1);
            this.credit = new text(creditFont);
